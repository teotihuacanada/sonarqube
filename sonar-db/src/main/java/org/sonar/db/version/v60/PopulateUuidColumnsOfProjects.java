...
public class PopulateUuidColumnsOfProjects extends BaseDataChange {
  ...
  private void populateRootUuidColumnForRoots(Context context) throws SQLException {
    ...
    massUpdate.execute(this::handleRootIdUpdateForRootNodes);
  }

  private boolean handleRootIdUpdateForRootNodes(Select.Row row, SqlStatement update) throws SQLException {
  ...
  private void populateRootUuidColumnForSubnodes(Context context, Map<Long, String> componentUuidById) throws SQLException {
  ...
  private boolean handleRootIdUpdateForSubNodes(Map<Long, String> componentUuidById, Select.Row row, SqlStatement update) throws SQLException {
    long rootId = row.getLong(1);
  ...
  private void populateCopyComponentUuidColumn(Context context, Map<Long, String> componentUuidById) throws SQLException {
    ...
    massUpdate.execute((row, update) -> this.handleCopyComponentUuidUpdate(componentUuidById, row, update));
  }

  private boolean handleCopyComponentUuidUpdate(Map<Long, String> componentUuidById, Select.Row row, SqlStatement update) throws SQLException {
  ...
  private boolean handleDeveloperUuuidUpdate(Map<Long, String> componentUuidById, Select.Row row, SqlStatement update) throws SQLException {
    long id = row.getLong(1);
