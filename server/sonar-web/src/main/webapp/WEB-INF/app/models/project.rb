...
class Project < ActiveRecord::Base
  ...
  belongs_to :copy_resource, :class_name => 'Project', :foreign_key => 'copy_component_uuid', :key => 'uuid'
  belongs_to :person, :class_name => 'Project', :foreign_key => 'developer_uuid', :key => 'uuid'
